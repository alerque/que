...
# Setup stuff
BASEPACKAGES=(base base-devel openssh cron ntp keychain ctags cyrus-sasl entr etckeeper fasd fzf gdisk git git-annex git-crypt gnupg html-xml-utils htop lab linux-headers lsof markdown2ctags mosh neomutt neovim pcregrep programmers-dvorak rsync ruby strace termite-terminfo tmux unrar unzip myrepos vcsh wget zip zsh ripgrep diff-so-fancy exim gnu-netcat rlwrap wireguard mlocate ncdu net-tools)

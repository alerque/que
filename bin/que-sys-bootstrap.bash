...
# Setup stuff
BASEPACKAGES=(base base-devel linux-headers zsh git ctags pcre-tools tmux sudo mosh etckeeper ruby zip unzip myrepos vcsh wget unrar lsof htop gdisk strace ntp programmers-dvorak rsync cyrus-sasl neomutt fzf fasd cron neovim git-crypt git-annex gnupg entr markdown2ctags html-xml-utils lab-git)

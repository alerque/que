...
# Setup stuff
BASEPACKAGES=(base base-devel openssh cron ctags cyrus-sasl entr etckeeper fasd fzf gdisk git git-annex git-crypt gnupg html-xml-utils htop lab linux-headers lsof markdown2ctags mosh neomutt neovim ntp pcregrep programmers-dvorak rsync ruby strace termite-terminfo tmux unrar unzip vcsh wget zip zsh)
